...
function Prices () {
    ...
    <div className="py-8 px-4 mx-auto max-w-[85rem] lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <h1 className="text-center text-5xl font-bold text-gray-800 mb-8">Pronto para começar?</h1>
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 ">
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-gray-100 rounded-lg border border-gray-200 shadow hover:scale-105 duration-300 ease-in-out">
                ...
                <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Melhor opção para projetos pessoais ou pequenos.</p>
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-gray-100 rounded-lg border border-gray-200 shadow hover:scale-105 duration-300 ease-in-out">
                ...
                <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Melhor para usos em larga escala e direitos de redistribuição estendidos.</p>
                <div className="flex justify-center items-baseline my-8">
