            ...
            <div className="space-y-6 lg:space-y-10">
              ...
              <div className="flex hover:scale-105 duration-200 ease-in">
                ...
                <div className="ms-5 sm:ms-8">
                  ...
                  <p className="mt-1 text-gray-600 dark:text-gray-400">
                    Colabore em tempo real com sua equipe, mantendo todos atualizados sobre o progresso do projeto. 
                  </p>
                </div>
              </div>
              ...
              <div className="flex hover:scale-105 duration-200 ease-in">
                ...
                <div className="ms-5 sm:ms-8">
                  ...
                  <p className="mt-1 text-gray-600 dark:text-gray-400">
                  Obtenha uma visão clara do status do seu projeto com nosso layout limpo e conciso. 
                  </p>
                </div>
              </div>
              ...
              <div className="flex hover:scale-105 duration-200 ease-in">
                ...
                <div className="ms-5 sm:ms-8">
                  ...
                  <p className="mt-1 text-gray-600 dark:text-gray-400">
                    Adapte o Kanban board às suas necessidades específicas com categorizações flexíveis. 
                  </p>
                </div>
              </div>
